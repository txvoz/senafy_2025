...
--
-- Servidor: localhost
-- Tiempo de generación: 05-12-2025 a las 03:00:53
...
CREATE TABLE `song` (
  ...
  `duration` int(11) NOT NULL COMMENT 'Duración total del audio',
...
CREATE TABLE `user` (
  ...
  `id_type` enum('CC','TI','RC','CE','PA','NIT','NIUP') NOT NULL COMMENT 'Tipo de documento (CC, CE, TI, etc.)',
  ...
  `gender` enum('M','F','NB','O','ND') DEFAULT NULL COMMENT 'Género del usuario',
