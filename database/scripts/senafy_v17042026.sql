...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-04-2026 a las 03:09:57
...
INSERT INTO `mascota` (`id`, `identificacion`, `nombre`, `raza`, `color`) VALUES
(1, '897', 'iii', 'Criollo', 'Blanca'),
(3, '123', 'Estrella', 'Criollo', 'Negra'),
(4, '4444', 'Chicky', 'Criollo', 'Blanca');
...
ALTER TABLE `mascota`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_mascota_identificacion` (`identificacion`);
